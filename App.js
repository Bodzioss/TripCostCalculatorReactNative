  ...
  return (
    <View style={styles.container}>
      <View style={styles.topView}>
        {/*App name*/}
        <Text style={styles.viewTitle}>Kalkulator kosztów podróży</Text>
        ...
        <View style={styles.passengerSection}>
          ...
          <View style={styles.item}>
            <View style={styles.itemLeft}>
                <TextInput style={styles.passengerName} placeholder={'Imie'} value = {passenger} onChangeText={text => setPassenger(text)}></TextInput>
            </View>
            <View style={styles.itemRight}>
                <TextInput style={styles.distanceInput} placeholder={'0'} keyboardType = 'numeric'  value = {passenger} onChangeText={text => setPassenger(text)}></TextInput>
        ...
        </View>
           {
              passengerItems.map((passenger, index) => {
                return <Passenger key={index} text={passenger}/>
              })
           }
          </View>
        </View>
